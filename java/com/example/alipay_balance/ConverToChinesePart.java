...
//中文数字
    private String[] source1 = {"零", "一", "二", "三", "四", "五", "六", "七", "八", "九"};
//数字单位
    private String[] source2 = {"千", "百", "十", "亿", "千", "百", "十", "万", "千", "百", "十", "元", "角", "分"};
...
//外部接口
    ...
    public static void main(String[] args) {
        ConverToChinesePart conver = new ConverToChinesePart(23434.54654);
